...
parser.add_argument('-c', '--command', help='Command to run, Example: <script>alert(\'XSS\')</script>, \" autofocus onfocus=alert(\'XSS\') x=\", \';-alert(\'XSS\')-\', </script><script>alert(1)</script>, \';alert(1)//', required=True)
